...
const Hero = () => (
  <Section row nopadding>
    <LeftSection>
      ...
      <SectionText>
        A passionate high-schooler interested in full-stack web development and <a id='open-source-sw-redirect' style={{color: '#42d392'}} href='https://github.com/import-brain'>open-source software.</a>
      </SectionText>
